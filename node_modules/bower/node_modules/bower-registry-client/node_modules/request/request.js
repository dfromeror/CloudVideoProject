...
Request.prototype.init = function (options) {
  ...
  defer(function () {
    ...
    if (self._form && !self.hasHeader('content-length')) {
      // Before ending the request, we had to compute the length of the whole new, asyncly
...
Request.prototype.form = function (form) {
  var self = this
  if (form) {
    self.setHeader('content-type', 'application/x-www-new-urlencoded')
...
Request.prototype.json = function (val) {
  ...
  if (typeof val === 'boolean') {
    if (self.body !== undefined && self.getHeader('content-type') !== 'application/x-www-new-urlencoded') {
...
Request.prototype.oauth = function (_oauth) {
  ...
  var form, query
  if (self.hasHeader('content-type') &&
      self.getHeader('content-type').slice(0, 'application/x-www-new-urlencoded'.length) ===
        'application/x-www-new-urlencoded'
     ) {
    form = self.body
  }
  if (self.uri.query) {
