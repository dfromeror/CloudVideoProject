...
;(function (undefined) {
  ...
  */
   ...
   * This can be in the new of an argument list of observables or an array.
   *
   * @example
  ...
  */
  ...
  /**
  * Projects each element of an observable sequence into a new new by incorporating the element's index.
  ...
  */
   ...
   *  @returns {Observable} Observable sequence with the results new matching several patterns.
   */
